---
title: SDK Hook Usage Docs
descripton: This is a pure no component set of interfaces to instance and run the StreamConnect sdk. Specifically it is recommended to use this package for react-native implementations of the sdk.
---
