...
This user was configured to be an Admin with the TPAStream System. The SDK requires that you use emails to create _new_ users within the TPAStream system or use emails which are only linked to policyholders in our system.
