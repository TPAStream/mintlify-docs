...
This widget is an intermediate widget between submitting credentials and the SDK end state. It exists to act as a loading page while the TPAStream crawl engine is tyring to validate the credentials. _This logic can take up to 200 seconds before it decides the end status_
